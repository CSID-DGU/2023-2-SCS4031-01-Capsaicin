...
export default function GuardHealthRecord() {
    ...
    useEffect(() => {
        const fetchBloodPressure = async () => {
            try {
                const response = await fetch(`${API}/guard/bloodpressure`, {
                    method: 'GET',
                    headers: {
                        'Content-Type': 'application/json',
        ...
        const fetchWeights = async () => {
            try {
                const response = await fetch(`${API}/guard/weights`, {
                    method: 'GET',
                    headers: {
                        'Content-Type': 'application/json',
                        'Authorization': `Bearer ${accessToken}`
        ...
        const fetchExerciseData = async () => {
            try {
                const response = await fetch(`${API}/guard/exercise`, {
                    method: 'GET',
                    headers: {
                        'Content-Type': 'application/json',
                        'Authorization': `Bearer ${accessToken}`
    ...
    return (
        ...
        <>
            <S.Container>
                ...
                <S.Info2>
                    <S.InfoTitle2>몸무게 기록</S.InfoTitle2>
                    <Table data={weights} />
                </S.Info2>

                <S.Info2>
                    <S.InfoTitle2>혈압 기록</S.InfoTitle2>
                    <BloodPressureTable data={bloodPressure} />
                </S.Info2>

                <S.Info2>
                    <S.InfoTitle2>운동 기록</S.InfoTitle2>
