...
export default function Food6() {
  ...
  useEffect(() => {
    ...
    const fetchFoods = async () => {
      try {
        const response = await fetch('http://127.0.0.1:8000/main/food/6', {// 여기서 1은 카테고리 번호입니다. 필요에 따라 동적으로 변경 가능
          headers: {
